...
const Services = () => {
  const services = [
    ...
    {id:3, title: "Clubs And Groups", description: "Our membership management software provides full automation of membership renewals and payments", image: "/src/assets/icons/group-clubs.png"},
  ]
  ...
  return (
    <div className='md:px-14 px-4 py-16 max-w-screen-2xl mx-auto' id='service'>
        ...
        <div className='mt-20 md:w-1/2 mx-auto text-center'>
          <h2 className='text-4xl text-neutralDGrey font-semibold mb-2'>Manage your entire community
        ...
        <div className='mt-14 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:w-11/12 mx-auto gap-12'>
          {
            services.map(service => <div key={services.id} className='px-4 py-8 text-center md:w-[300px]
