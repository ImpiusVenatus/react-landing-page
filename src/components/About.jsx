...
const About = () => {
  return (
    <div>
        ...
        {/*Company Stats*/}
        <div className='px-4 lg:px-14 flex items-center justify-center max-w-screen-4xl bg-neutralSilver py-16'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                ...
                {/*Stats*/}
                <div className='md:w-1/2 mx-auto flex sm:flex-row flex-col sm:items-center 
